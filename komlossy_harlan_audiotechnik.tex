...
\end{itemize}
Der visuelle Eindruck einer Korrelation wird vom linearen Korrelationskoeffizient nach Pearsons \textcolor{red}{(Quelle)} \textcolor{blue}{(0.52 für Melodie, 0.71 für Rhythmus)} unterstützt. Und auch der Rangkorrelationskoeffizient nach Spearman \textcolor{red}{(Quelle)} \textcolor{blue}{(0.54 für Melodie, 0.84 für Rhythmus)} widerspricht diesem nicht.
...
Eine andere Erklärung könnte sein, dass gerade bei weniger ausgeprägten musikalischen Vorkenntnissen viele Personen sich mehr mit Melodien als mit Rhythmen und Tonlängen beschäftigen. 
